...
pub const enum_VkResult = extern enum {
    ...
    VK_RESULT_BEGIN_RANGE = -4294967284,
...
pub const VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
pub const VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT;
pub const VK_PIPELINE_STAGE_VERTEX_INPUT_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
pub const VK_PIPELINE_STAGE_VERTEX_SHADER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
pub const VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT;
pub const VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT;
pub const VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT;
pub const VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
pub const VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
pub const VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
pub const VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
pub const VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT;
pub const VK_PIPELINE_STAGE_TRANSFER_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_TRANSFER_BIT;
pub const VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT;
pub const VK_PIPELINE_STAGE_HOST_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_HOST_BIT;
pub const VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT;
pub const VK_PIPELINE_STAGE_ALL_COMMANDS_BIT = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_ALL_COMMANDS_BIT;
pub const VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX;
pub const VK_PIPELINE_STAGE_FLAG_BITS_MAX_ENUM = enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_FLAG_BITS_MAX_ENUM;
pub const enum_VkPipelineStageFlagBits = extern enum {
...
pub const VK_ACCESS_INDIRECT_COMMAND_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_INDIRECT_COMMAND_READ_BIT;
pub const VK_ACCESS_INDEX_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_INDEX_READ_BIT;
pub const VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT;
pub const VK_ACCESS_UNIFORM_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_UNIFORM_READ_BIT;
pub const VK_ACCESS_INPUT_ATTACHMENT_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_INPUT_ATTACHMENT_READ_BIT;
pub const VK_ACCESS_SHADER_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_SHADER_READ_BIT;
pub const VK_ACCESS_SHADER_WRITE_BIT = enum_VkAccessFlagBits.VK_ACCESS_SHADER_WRITE_BIT;
pub const VK_ACCESS_COLOR_ATTACHMENT_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_COLOR_ATTACHMENT_READ_BIT;
pub const VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT = enum_VkAccessFlagBits.VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
pub const VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT;
pub const VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT = enum_VkAccessFlagBits.VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
pub const VK_ACCESS_TRANSFER_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_TRANSFER_READ_BIT;
pub const VK_ACCESS_TRANSFER_WRITE_BIT = enum_VkAccessFlagBits.VK_ACCESS_TRANSFER_WRITE_BIT;
pub const VK_ACCESS_HOST_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_HOST_READ_BIT;
pub const VK_ACCESS_HOST_WRITE_BIT = enum_VkAccessFlagBits.VK_ACCESS_HOST_WRITE_BIT;
pub const VK_ACCESS_MEMORY_READ_BIT = enum_VkAccessFlagBits.VK_ACCESS_MEMORY_READ_BIT;
pub const VK_ACCESS_MEMORY_WRITE_BIT = enum_VkAccessFlagBits.VK_ACCESS_MEMORY_WRITE_BIT;
pub const VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX = enum_VkAccessFlagBits.VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX;
pub const VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX = enum_VkAccessFlagBits.VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX;
pub const VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT = enum_VkAccessFlagBits.VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT;
pub const VK_ACCESS_FLAG_BITS_MAX_ENUM = enum_VkAccessFlagBits.VK_ACCESS_FLAG_BITS_MAX_ENUM;
pub const enum_VkAccessFlagBits = extern enum {
...
pub const VK_SUBPASS_EXTERNAL = if (@typeId(@typeOf(U)) == @import("builtin").TypeId.Pointer) @ptrCast(~0, U) else if (@typeId(@typeOf(U)) == @import("builtin").TypeId.Int) @intToPtr(~0, U) else (~0)(U);
